...
require('STACK_LIMIT_META_KEY = "stack-limit"' in main, 'LuckPerms meta key fixed to stack-limit')
require('V1_MAX_LIMIT = 99' in main and 'VANILLA_DEFAULT_LIMIT = 64' in main, 'v1 range constants are 64..99')
