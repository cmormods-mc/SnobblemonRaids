...
def validate_tree() -> None:
    ...
    # Tier selection, spawn announcements and the two admin commands used to be asserted here by
    # matching source text, which broke on the spawn-package split without anything being wrong.
    # They are covered better elsewhere now and by things that fail on behaviour rather than
